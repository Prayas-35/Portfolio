...
import { projects, type Project } from "@/lib/projects.schema";
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        ...
        >
          <Card className="group relative h-full overflow-hidden border border-white/[0.08] bg-gradient-to-br from-white/[0.07] via-white/[0.04] to-transparent backdrop-blur-sm transition-all duration-500 hover:-translate-y-2 hover:border-white/20 hover:shadow-2xl hover:shadow-purple-500/10">
            ...
            <div className="pointer-events-none absolute inset-0 rounded-xl bg-gradient-to-br from-purple-500/0 via-transparent to-blue-500/0 opacity-0 transition-all duration-500 group-hover:from-purple-500/10 group-hover:to-blue-500/10 group-hover:opacity-100" />
            <div className="pointer-events-none absolute -inset-px rounded-xl bg-gradient-to-br from-purple-500/20 via-transparent to-blue-500/20 opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
          </Card>
        </button>
      </DialogTrigger>
